...
globalkeys = gears.table.join(
  ...
  awful.key({ }, "Print", function() awful.spawn("flameshot gui") end,
    { description = "flameshot gui", group = "utils" }),
  awful.key({ modkey }, "g", function() awful.spawn("rofi -show calc -modi calc -no-show-match -no-sort") end,
    { description = "rofi calculator", group = "utils" }),
  awful.key({ modkey }, "b", function() awful.spawn("firefox") end,
    { description = "run firefox", group = "launcher" }),
  awful.key({ modkey }, "e", function() awful.spawn("thunar") end,
    { description = "run thunar", group = "launcher" }),
  awful.key({ modkey }, "p", function() awful.spawn("dm-tool lock") end,
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "t",      function (c) c.sticky = not c.sticky  end,
    { description = "make it sticky", group = "client" }),
  awful.key({ modkey, }, "n",
    function(c)
